const project = [
    //  card one
    {
        ...
        Links: ['CSS', 'Github', 'Javascript', 'HTML'],
        description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the r00elea",
    ...
    //  card two
    {
        image: './Image/mobile-modal-2.svg',
        articleTitle: 'Multi-Post Stories',
        languages: ['Ruby on rails', 'CSS', 'JavaScript', 'HTML'],
        seeProject: 'See Project',
        Links: ['CSS', 'Github', 'Javascript', 'HTML'],
    ...
    const cardModal = project.map((card) => ` <div class="project-card-bg">
        <div class="project-card">
          ...
          <div class="project-buttons">
              ...
              <img src="./image/see-live-icon.svg" alt="">
              </a>
